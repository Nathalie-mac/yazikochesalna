...
2. Отображение последнего сообщения в диалоге на главной странице (готово API, в разработке на фронте)
3. Отображение статуса онлайн/офлайн (в разработке на беке)
4. Отображение непрочитанных сообщений (в разработке на беке)
